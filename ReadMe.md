Source code for an additive synthesizer VST with per-partial envelope control, and a Python interface for generating control data for the synth programatically.
